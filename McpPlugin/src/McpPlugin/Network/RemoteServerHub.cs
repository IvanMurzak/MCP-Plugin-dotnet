...
{
    public class RemoteServerHub : IRemoteServerHub
    {
        readonly ILogger<RemoteServerHub> _logger;
        ...
        public RemoteServerHub(ILogger<RemoteServerHub> logger, Version apiVersion, IConnectionManager connectionManager, IMcpManager mcpManager)
        {
